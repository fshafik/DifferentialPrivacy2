...
df = pd.read_csv('DP-indv_hour_10.csv')
...
clf = MLPClassifier(hidden_layer_sizes=(n,n,n,n),solver='adam',random_state=1,learning_rate_init=0.001,verbose=10,tol=0.000100, max_iter=500)
